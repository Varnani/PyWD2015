...
class Ui_EclipseWidget(object):
    def setupUi(self, EclipseWidget):
        ...
        EclipseWidget.setMinimumSize(QtCore.QSize(0, 0))
        EclipseWidget.setMaximumSize(QtCore.QSize(10000, 10000))
        ...
        self.label_11.setGeometry(QtCore.QRect(170, 70, 51, 20))
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.sigma_ipt = QtGui.QLineEdit(EclipseWidget)
        self.sigma_ipt.setGeometry(QtCore.QRect(220, 70, 101, 21))
        self.sigma_ipt.setObjectName(_fromUtf8("sigma_ipt"))
        self.line_13 = QtGui.QFrame(EclipseWidget)
        self.line_13.setGeometry(QtCore.QRect(40, 90, 251, 21))
