...
class Ui_SyntheticCurveWidget(object):
    def setupUi(self, SyntheticCurveWidget):
        ...
        self.gridLayout.addWidget(self.fillout_label, 12, 0, 1, 2)
        self.line_4 = QtGui.QFrame(SyntheticCurveWidget)
        self.line_4.setFrameShape(QtGui.QFrame.HLine)
        self.line_4.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_4.setObjectName(_fromUtf8("line_4"))
        self.gridLayout.addWidget(self.line_4, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.roche_chk, 10, 0, 1, 2)
