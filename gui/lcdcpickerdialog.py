...
class Ui_LCDCPickerDialog(object):
    def setupUi(self, LCDCPickerDialog):
        ...
        LCDCPickerDialog.resize(680, 430)
        LCDCPickerDialog.setMinimumSize(QtCore.QSize(680, 430))
        LCDCPickerDialog.setMaximumSize(QtCore.QSize(680, 430))
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 50, 641, 111))
    ...
    def retranslateUi(self, LCDCPickerDialog):
        ...
        self.label_2.setText(_translate("LCDCPickerDialog", "PyWD2015 is a GUI for LC and DC programs of Wilson - Devinney eclipsing binary modeling software. PyWD2015 needs these programs to function properly. Please provide their paths below.\n"
"\n"
"If you got this program from the GitHub release page, you probably have them in /PyWD2015/wd/ path with necessary files. If you don\'t, you can grab them from GitHub or compile the source codes from WD Homepage yourself.", None))
