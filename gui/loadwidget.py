...
# Form implementation generated from reading ui file 'gui/wd_loadwidget.ui'
#
...
class Ui_LoadWidget(object):
    def setupUi(self, LoadWidget):
        ...
        self.line_2.setGeometry(QtCore.QRect(140, 150, 341, 20))
    ...
    def retranslateUi(self, LoadWidget):
        ...
        self.label.setText(_translate("LoadWidget", "Velocity curve for star 1", None))
        ...
        self.label_6.setText(_translate("LoadWidget", "Velocity curve for star 2", None))
        self.nlc_label.setText(_translate("LoadWidget", "Number of Light Curves: 0", None))
